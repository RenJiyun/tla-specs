...
\@x{ {\VARIABLE} turn}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} row1 ,\, row2 ,\, row3}%
\@x{ {\VARIABLES} col1 ,\, col2 ,\, col3}%
\@x{ {\VARIABLES} rows ,\, cols ,\, diags}%
\@pvspace{16.0pt}%
\@x{ RowInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \A\, row \.{\in} rows \.{:} row \.{\in} Seq ( \{ 0
 ,\, nil \} ) \.{\lor} row \.{\in} Seq ( \{ 1 ,\, nil \} )}%
\@pvspace{16.0pt}%
\@x{ ColInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \A\, col \.{\in} cols \.{:} col \.{\in} Seq ( \{ 0
 ,\, nil \} ) \.{\lor} col \.{\in} Seq ( \{ 1 ,\, nil \} )}%
\@pvspace{16.0pt}%
\@x{ DiagInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \A\, diag \.{\in} diags \.{:} diag \.{\in} Seq ( \{ 0
 ,\, nil \} ) \.{\lor} diag \.{\in} Seq ( \{ 1 ,\, nil \} )}%
\@pvspace{16.0pt}%
\@x{ TicTacToeInvariant \.{\defeq}}%
\@x{\@s{16.4} \.{\land} RowInvariant}%
\@x{\@s{16.4} \.{\land} ColInvariant}%
\@x{\@s{16.4} \.{\land} DiagInvariant}%
\@pvspace{16.0pt}%
\@x{ TicTacToeInit \.{\defeq}}%
\@x{\@s{16.4} \.{\land} turn \.{=} A}%
\@pvspace{16.0pt}%
\@x{ Aplay \.{\defeq}}%
\@x{\@s{16.4} \.{\land} turn \.{=} A}%
\@pvspace{24.0pt}%
\@x{ Bplay \.{\defeq}}%
\@x{\@s{16.4} \.{\land} turn \.{=} B}%
\@pvspace{16.0pt}%
\@x{ TicTacToeNext \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} Aplay}%
\@x{\@s{16.4} \.{\lor} Bplay}%
\@pvspace{136.0pt}%
\@x{}\bottombar\@xx{}%
