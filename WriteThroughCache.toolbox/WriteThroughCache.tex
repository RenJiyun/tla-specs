...
\@x{}\moduleLeftDash\@xx{ {\MODULE} WriteThroughCache}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences ,\, MemoryInterface}%
\@x{ {\VARIABLES} wmem ,\, ctl ,\, buf ,\, cache ,\, memQ}%
\@x{ {\CONSTANT} QLen}%
\@x{ {\ASSUME} ( QLen \.{\in} Nat ) \.{\land} ( QLen \.{>} 0 )}%
\@x{ M \.{\defeq} {\INSTANCE} InternalMemory {\WITH} mem \.{\leftarrow} wmem}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} M {\bang} IIint}%
 \@x{\@s{16.4} \.{\land} cache \.{=} [ p \.{\in} Proc \.{\mapsto} [ a \.{\in}
 Adr \.{\mapsto} NoVal ] ]}%
\@x{\@s{16.4} \.{\land} memQ \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq}}%
\@x{\@s{16.4} \.{\land} wmem \.{\in} [ Adr \.{\rightarrow} Val ]}%
 \@x{\@s{16.4} \.{\land} ctl\@s{3.64} \.{\in} [ Proc\@s{10.28} \.{\rightarrow}
 \{\@w{rdy} ,\,\@w{busy} ,\,\@w{waiting} ,\,\@w{done} \} ]}%
 \@x{\@s{16.4} \.{\land} buf \.{\in} [ Proc\@s{10.28} \.{\rightarrow} MReq
 \.{\lor} Val \.{\lor} \{ NoVal \} ]}%
 \@x{\@s{16.4} \.{\land} cache \.{\in} [ Proc \.{\rightarrow} [ Adr
 \.{\rightarrow} Val \.{\lor} NoVal ] ]}%
\@x{\@s{16.4} \.{\land} memQ \.{\in} Seq ( Proc \.{\times} MReq )}%
\@pvspace{248.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
